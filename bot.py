...
QUESTIONS = [
    ...
    "21. Соңғы кезде ұсақ мәселелерді де қатты уайымдап, ойдан шығара бересіз бе?",
    "22. Өз ойларыңызды тоқтату немесе тыныштандыру қиын болып жүр ме?",
    "23. Күн ішінде жиі өзіңізді шаршаған немесе әлсіз сезінесіз бе?",
    "24. Соңғы уақытта өзіңізге деген сеніміңіз төмендегенін байқайсыз ба?",
    "25. Көп жағдайда өзіңізді тыныш ұстай алмай, ішкі қысым сезінесіз бе?",
]
